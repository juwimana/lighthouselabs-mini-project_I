...
def main():
	...
	html_main_page_title = "<div class='shadow p-3 mb-5 bg-white rounded' style='text-allign:center'><h2 style='text-align:left; font-weight:550;'>Transport of London API Mini Project</h2></div>"
